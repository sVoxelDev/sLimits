...
import net.silthus.slib.components.ComponentInformation;
import net.silthus.slib.components.InvalidComponentException;
import net.silthus.slib.components.TemplateComponent;
...
public abstract class AbstractComponentLoader implements ComponentLoader {
    ...
    protected AbstractComponent instantiateComponent(Class<?> clazz) throws Throwable {
        ...
        // Instantiation!
        Constructor<? extends AbstractComponent> construct =
                clazz.asSubclass(AbstractComponent.class).getConstructor();
        return construct.newInstance();
    }

    public boolean isComponentClass(Class<?> clazz) {
        return clazz != null
                && AbstractComponent.class.isAssignableFrom(clazz)
                && !clazz.isAnnotationPresent(TemplateComponent.class);
    }
